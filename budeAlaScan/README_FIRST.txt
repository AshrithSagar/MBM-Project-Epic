...
The doc directory has the README and Using budeAlaScan in html, pdf, txt and odt 
...
The previous command will unpack the budeAlaScan, compile the C++ programs and 
update/create the initialisation file ‘.budeAlaScan.ini’ in your home directory.
